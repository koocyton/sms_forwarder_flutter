Map<String, String> get ruLang => {
  ...
  "App:Today":"Today",
  "App:Tip title":"Угостите разработчика кофе",
  "App:Tip desc":"Если приложение вам помогает, небольшие чаевые — отличная поддержка!",
  "App:Tip thanks":"Спасибо за вашу поддержку!",
  "App:Tip unavailable":"Чаевые сейчас недоступны",
